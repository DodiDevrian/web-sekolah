    ...
    <div class="container">
        ...
        <div class="row courses_row">
            ...
            <div class="col-lg-4 course_col">
                <div class="course">
                    <div class="course_image"><img src="<?php base_url() ?>template/front-end/images/course_1.jpg" alt=""></div>
            ...
            <div class="col-lg-4 course_col">
                <div class="course">
                    <div class="course_image"><img src="<?php base_url() ?>template/front-end/images/course_2.jpg" alt=""></div>
                    <div class="course_body">
            ...
            <div class="col-lg-4 course_col">
                <div class="course">
                    <div class="course_image"><img src="<?php base_url() ?>template/front-end/images/course_3.jpg" alt=""></div>
                    <div class="course_body">
...
<div class="counter">
    <div class="counter_background" style="background-image:url(<?php base_url() ?>template/front-end/images/counter_background.jpg)"></div>
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
            ...
            <div class="col-lg-7 news_col">
                ...
                <div class="news_post_large_container">
                    <div class="news_post_large">
                        <div class="news_post_image"><img src="<?php base_url() ?>template/front-end/images/news_1.jpg" alt=""></div>
...
<div class="newsletter">
    <div class="newsletter_background parallax-window" data-parallax="scroll" data-image-src="<?php base_url() ?>template/front-end/images/newsletter.jpg" data-speed="0.8"></div>
    <div class="container">
        <div class="row">
            <div class="col">
