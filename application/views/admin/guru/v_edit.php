            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="tempat_lahir" value="<?= $guru->tempat_lahir ?>" placeholder="Masukkan Tempat Lahir" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Tanggal Lahir</label>
                        <input id="tanggal" class="form-control" type="text" name="tgl_lahir" value="<?= $guru->tgl_lahir ?>" placeholder="Masukkan Tanggal Lahir" required>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group search_select_box">
                        ...
                        <select name="id_mapel" class="form-control" data-live-search="true">
