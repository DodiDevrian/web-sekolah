    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="nama_guru" placeholder="Masukkan Nama Lengkap Disertai Dengan Gelar" required>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group search_select_box">
                        ...
                        <select id="id_mapel" name="id_mapel" class="form-control" data-live-search="true">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select id="id_pend" name="pendidikan" class="form-control">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="file" name="foto_guru" placeholder="Masukkan Tempat Lahir" required>
            </div>
