            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="tempat_lahir" value="<?= $pegawai->tempat_lahir ?>" placeholder=" Masukkan Tempat Lahir" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Tanggal Lahir</label>
                        <input id="tanggal" class="form-control" type="text" name="tgl_lahir" value="<?= $pegawai->tgl_lahir ?>" placeholder=" Masukkan Tanggal Lahir" required>
                    </div>
                </div>
            </div>
